...
export function isEachCardEven(stack) {
  return stack.every(currentCard => currentCard % 2 === 0)
}
...
export function doesStackIncludeOddCard(stack) {
 return stack.some(currentCard => currentCard % 2 === 1)
}
...
export function getFirstOddCard(stack) {
  return stack.find(currentCard => currentCard % 2 === 1)
}
...
export function getFirstEvenCardPosition(stack) {
  return stack.findIndex(currentCard => currentCard % 2 === 0)
}
